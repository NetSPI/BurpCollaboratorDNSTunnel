...
public class BurpExtender implements IBurpExtender, ITab {
    ...
    class StartCollabButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            //Using the default Burp Collaborator server breaks BurpSuite's Terms and Conditions.
            if (isServerLocationDefault(collabContext)) {
                receiveTextArea.setText("You are using the default Burp Collaborator server.  Please specify a private server in Project Options > Misc.");
                collabContext = null;
            } else {
        ...
        //Check if the current Collaborator server is the default one.  We don't want to allow anyone to use the default, as
        // it breaks BurpSuite's Terms and Conditions.
        private boolean isServerLocationDefault(IBurpCollaboratorClientContext collabContext) {
            return collabContext.getCollaboratorServerLocation().equals("burpcollaborator.net");
        }
    }
